...
public class LineTiny : MonoBehaviour
{
    [SerializeField]
   public GameObject startObj, endObj,arrow;
    ...
    private void OnDrawGizmos()
    {
        ...
        this.GetComponent<SpriteRenderer>().size = new Vector2(2 * ((Vector2)endObj.transform.position - (Vector2)startObj.transform.position).magnitude, 0.8f);
